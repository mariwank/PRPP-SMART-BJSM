...
alphaP_link <- c(1.1, 1.02, 1.05, 1.2)               # alpha_p1A (1st stage preference, T1=A), alpha_p1B (1st stage preference, T1=B), alpha_p2C (2nd stage preference, T2=C), alpha_p2D (2nd stage preference, T2=D)
